...
/**
 * 
 * Baseado no Livro Genetic Algorithms in Java Basics Lee Jacobson Burak Kanber
 *
 */
public class AllOnesGA {
	...
	public static void main(String[] args) {
		...
		while (ga.isTerminationConditionMet(populacao) == false) {
			...
			System.out.println("Melhor Individuo: " + populacao.getFittest(0).toString() + " aptidao "
					+ populacao.getFittest(0).getFitness());
